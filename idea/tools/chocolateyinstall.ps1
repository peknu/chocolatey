...
$packageName = 'idea' # arbitrary name for the package, used in messages
$toolsDir = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url = 'http://download.jetbrains.com/idea/ideaIU-14.1.5.exe' # download url
$url64 = $url
...
$packageArgs = @{
  ...
  #OTHERS
  silentArgs    = '/S /NCRC /D=C:\Java\JetBrains\Intellij IDEA 14.1.5'
  #validExitCodes= @(0) #please insert other valid exit codes here

  # optional
  registryUninstallerKey = 'idea' #ensure this is the value in the registry
  checksum      = ''
